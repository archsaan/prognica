...
<div class="panel panel-sign">
    ...
    <div class="panel-body">
        ...
        <div class="checkbox-custom checkbox-default">
            {{ FORM::checkbox('consent', '1', null, ['id' => 'consent', 'required' => 'true'])}}   
            @if ($errors->has('consent'))
            <span class="invalid-feedback alert-danger" role="alert">
                <strong>{{ $errors->first('consent') }}</strong>
            </span>
            @endif
            <label for="consent">I have read the <a href="" target="_blank"> Terms and Condition</a> and agree to comply fully</label>
        </div>							
        <label id="consent-error" class="error" for="consent" style="display: inline;"></label>
