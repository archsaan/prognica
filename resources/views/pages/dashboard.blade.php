...
<header class="page-header">
    <div class="right-wrapper pull-right">
        <ol class="breadcrumbs docs-buttons">
            ...
            <button type="button" class="mb-xs mt-xs mr-xs btn btn-primary"><i class="fa fa-check"></i> Approve Report</button> 
            @endif
            <a href="{{ url('pdf') }}" class="mb-xs mt-xs mr-xs btn btn-primary"><i class="fa fa-file-text-o"></i> Download Report</a>
            <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
        </ol>
        <div class="dropdown">
...
<section class="panel">
    <div class="panel-body">
        ...
        <p class="text-dark text-center">
            <i class="fa fa-download" aria-hidden="true"></i>&nbsp;&nbsp; Please <a href="{{ url('/download_sample') }}"><b>click here</b></a> to download sample file.
        </p>
    </div>
</section>
<!-- /image cropping -->
